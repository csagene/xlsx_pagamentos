...
def processar_relatorio(df, template):
    ...
    elif "short_delegation" in colunas_norm:
        col_short = colunas_norm["short_delegation"]
        
    if col_short:
        for c_norm in ["delegacao", "delegação", "delegation"]:
    ...
    aliases = {
        ...
        "delegação": ["delegacao", "delegação", "short_delegacao", "short_delegation"],
